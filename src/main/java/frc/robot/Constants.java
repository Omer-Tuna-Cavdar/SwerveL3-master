...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final int angleContinuousCurrentLimit = 25; //20
    public static final int driveContinuousCurrentLimit = 25; //80, limiting the amps so Neo won't brake
    ...
    public static final class Mod3 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromRotations(-0.015);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
  }
}